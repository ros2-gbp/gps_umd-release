## gps_umd (rolling) - 3.1.1-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Sat, 15 Aug 2026 22:12:33 -0000`
...
## gps_umd (lyrical) - 3.1.1-1

The packages in the `gps_umd` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical gps_umd` on `Sat, 15 Aug 2026 22:06:58 -0000`
...
## gps_umd (kilted) - 3.1.1-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Sat, 15 Aug 2026 22:03:30 -0000`
...
## gps_umd (rolling) - 3.1.0-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Wed, 22 Jul 2026 15:10:08 -0000`
...
## gps_umd (lyrical) - 3.1.0-1

The packages in the `gps_umd` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical gps_umd` on `Wed, 22 Jul 2026 15:08:19 -0000`
...
## gps_umd (kilted) - 3.1.0-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Wed, 22 Jul 2026 15:05:21 -0000`
...
## gps_umd (jazzy) - 3.1.0-1

The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Wed, 22 Jul 2026 15:03:06 -0000`
...
## gps_umd (humble) - 3.1.0-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Wed, 22 Jul 2026 15:00:26 -0000`
...
## gps_umd (humble) - 2.3.0-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Wed, 08 Jul 2026 20:31:17 -0000`
...
## gps_umd (rolling) - 3.0.0-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Wed, 08 Jul 2026 20:27:05 -0000`
...
## gps_umd (lyrical) - 3.0.0-1

The packages in the `gps_umd` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical gps_umd` on `Wed, 08 Jul 2026 20:25:37 -0000`
...
## gps_umd (kilted) - 3.0.0-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Wed, 08 Jul 2026 20:24:07 -0000`
...
## gps_umd (jazzy) - 3.0.0-1

The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Wed, 08 Jul 2026 20:21:55 -0000`
...
## gps_umd (lyrical) - 2.1.2-4

The packages in the `gps_umd` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical gps_umd` on `Tue, 02 Jun 2026 22:07:18 -0000`
...
## gps_umd (rolling) - 2.1.2-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Fri, 13 Mar 2026 17:27:14 -0000`
...
## gps_umd (kilted) - 2.1.2-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Fri, 13 Mar 2026 17:24:14 -0000`
...
## gps_umd (jazzy) - 2.1.2-1

The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Fri, 13 Mar 2026 17:20:41 -0000`
...
## gps_umd (humble) - 2.1.2-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Fri, 13 Mar 2026 17:16:33 -0000`
...
## gps_umd (rolling) - 2.1.1-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Mon, 07 Jul 2025 15:03:53 -0000`
...
## gps_umd (kilted) - 2.1.1-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Mon, 07 Jul 2025 14:59:37 -0000`
...
## gps_umd (jazzy) - 2.1.1-1

The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Mon, 07 Jul 2025 14:55:16 -0000`
...
## gps_umd (humble) - 2.1.1-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Mon, 07 Jul 2025 14:50:37 -0000`
...
## gps_umd (rolling) - 2.1.0-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Tue, 27 May 2025 19:07:29 -0000`
...
## gps_umd (kilted) - 2.1.0-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Tue, 27 May 2025 19:04:04 -0000`
...
The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Tue, 27 May 2025 19:00:52 -0000`
...
## gps_umd (humble) - 2.1.0-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Tue, 27 May 2025 18:35:02 -0000`
...
## gps_umd (rolling) - 2.0.5-1

The packages in the `gps_umd` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling gps_umd` on `Tue, 20 May 2025 18:51:18 -0000`
...
## gps_umd (kilted) - 2.0.5-2

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Tue, 20 May 2025 18:48:14 -0000`
...
## gps_umd (kilted) - 2.0.5-1

The packages in the `gps_umd` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted gps_umd` on `Tue, 20 May 2025 18:44:58 -0000`
...
## gps_umd (jazzy) - 2.0.5-1

The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Tue, 20 May 2025 18:37:04 -0000`
...
## gps_umd (humble) - 2.0.5-1

The packages in the `gps_umd` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble gps_umd` on `Tue, 20 May 2025 18:32:32 -0000`
...
The packages in the `gps_umd` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy gps_umd` on `Fri, 27 Sep 2024 22:45:15 -0000`
